...
function setCardType(type) {
  const colors = {
    default: ["#FFC632", "#FFC632"],
    visa: ["#00B5EE", "#1200E7"],
    mastercard: ["#C81B1B", "#DF6F29"],
    elo: ["#C21313", "#2D57F2"],
    americanExpress: ["#16084C", "#FFFFFF"],
    discover: ["#FC6A00", "#E4DB00"],
    diners: ["#01FF85", "#FD4688"],
    maestro: ["#FF0000", "#BD00FF"],
    aura: ["#0094FF", "#EBFF00"],
    hipercard: ["#14FF00", "#00C2FF"],
    jcb: ["#70FF00", "#EB00FF"],
  }
...
const expirationDatePattern = {
  ...
  blocks: {
    ...
    YY: {
      ...
      to: String(new Date().getFullYear() + 13).slice(2),
    },
  },
}
